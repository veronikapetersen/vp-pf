            ...
            {ProjectsData.filter((project) => project.slug === params.slug).map((project) => (
                <main key={project.id} ref={mainRef}>
                    <ProjectPageLayout >
                        ...
                        {project.images &&
                            <ProjectImage url={project.images[0].url} description={project.images[0].img_description} />
                        }
                        ...
                        {project.images &&
                            <ProjectImage url={project.images[1].url} description={project.images[1].img_description} />
                        }
